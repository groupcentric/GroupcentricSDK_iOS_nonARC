...
/**
 * Integrates gc_SDWebImage async downloading and caching of remote images with UIImageView.
 *
 * Usage with a UITableViewCell sub-class:
 *
 * 	#import <gc_SDWebImage/UIImageView+WebCache.h>
 * 	
 * 	...
 * 	
 ...
 * 	
 */
@interface UIImageView (WebCache) <gc_SDWebImageManagerDelegate>
