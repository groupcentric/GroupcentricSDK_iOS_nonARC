...
#import "gc_UA_ASIHTTPRequestDelegate.h"
#import "gc_UA_ASIProgressDelegate.h"

@interface UA_ASINetworkQueue : NSOperationQueue <UA_ASIProgressDelegate, UA_ASIHTTPRequestDelegate, NSCopying> {
