...
typedef void (^gc_RequestGroupListCallback)(NSArray *groups, NSError *error);
typedef void (^gc_RequestNotificationsCallback)(NSArray *notifications, NSError *error);
...
typedef enum {
	GCMessageTypeText = 0,
	GCMessageTypePhoto,
	GCMessageTypeLocation,
    GCMessageTypeURL,
    GCMessageTypeSharedObject,
} GCMessageType;

@interface Groupcentric : NSObject <GCRequestDelegate> {
...
-(void)getGroups:(gc_RequestGroupListCallback)block;
/*
 Returns:
...
-(void)startGroupWithTitle:(NSString *)grpTitle
                ...
                andMessage:(NSString *)msg
               andContacts:(NSArray *)cntcts
                 andObject:(GCSharedObject *)object
                    result:(gc_RequestGroupCallback)block;
/*
 Returns:
 GCGroup     Group details
...
-(void)getNotifications:(gc_RequestNotificationsCallback)block;
/*
 Returns:
...
@property (nonatomic, copy) gc_RequestGroupListCallback groupListCallbackBlock;
@property (nonatomic, copy) gc_RequestNotificationsCallback notificationsCallbackBlock;
