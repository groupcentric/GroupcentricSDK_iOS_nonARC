...
@property (nonatomic, strong) NSMutableArray *  friends; // Array of GCFriend objects
...
@property (nonatomic, strong) NSMutableArray *  messages; // Array of GCMessage objects
