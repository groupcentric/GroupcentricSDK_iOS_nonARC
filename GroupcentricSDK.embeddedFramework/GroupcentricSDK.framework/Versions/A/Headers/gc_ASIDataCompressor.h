...
// This is a helper class used by gc_ASIHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface gc_ASIDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
