...
// This is a helper class used by gc_ASIHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface gc_ASIDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
