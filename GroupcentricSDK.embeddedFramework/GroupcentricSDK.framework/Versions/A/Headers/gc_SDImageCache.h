...
/**
 * gc_SDImageCache maintains a memory cache and an optional disk cache. Disk cache write operations are performed
 * asynchronous so it doesn’t add unnecessary latency to the UI.
 */
@interface gc_SDImageCache : NSObject
{
 ...
 *
 * @return gc_SDImageCache global instance
 */
 ...
 * @param info An Ngc_SDictionary with some user info sent back to the delegate
 */
