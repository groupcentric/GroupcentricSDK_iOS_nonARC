...
#import "gc_ASIHTTPRequestDelegate.h"
#import "gc_ASIProgressDelegate.h"

@interface gc_ASINetworkQueue : NSOperationQueue <gc_ASIProgressDelegate, gc_ASIHTTPRequestDelegate, NSCopying> {
...
// All gc_ASINetworkQueues are paused when created so that total size can be calculated before the queue starts
